  ...
  return (
    <div className="flex items-center p-5  border bg-white shadow-lg my-3 ml-auto mr-auto">
        ...
        <div className="p-4 w-4/6">
            <h2 className="sm:text-sm md:text-2xl font-bold ">{producto.nombre}</h2>
        ...
        <div className="md:flex md:gap-2 w-1/6 sm:block">
        <button 
              type="button"
            ...
            <button 
              ...
              className="bg-yellow-500 p-1 rounded-md text-black mt-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
